...
export const gridItems = [
  {
    ...
    description: "",
    className: "md:col-span-6 lg:col-span-2 md:row-span-2 lg:min-h-[60vh]",
  ...
  },
  {
    ...
    description: "",
    className: "md:col-span-3 lg:col-span-1 md:row-span-1",
    imgClassName: "",
  ...
  },
  {
    ...
    className: "md:col-span-3 lg:col-span-1 md:row-span-2",
    imgClassName: "",
